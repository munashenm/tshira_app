...
const TRANSITION_RULES: Partial<Record<CaseStatus, CaseStatus[]>> = {
  ...
  DATA_SUBMITTED: ["PROVINCIAL_QUALITY_CHECK"],
  ...
  SUBMITTED_TO_HEAD_OFFICE: ["ASSIGNED_TO_CONSULTANT"],
  ASSIGNED_TO_CONSULTANT: ["DOCUMENT_IN_PROGRESS"],
...
const STATUS_ROLE_RULES: Partial<Record<CaseStatus, Role[]>> = {
  ...
  RETURNED_FOR_DATA_CORRECTION: [Role.PROVINCIAL_COORDINATOR, Role.REVIEWER],
