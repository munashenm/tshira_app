    ...
    <div className="p-8 space-y-8 bg-zinc-50 dark:bg-zinc-950 min-h-screen pb-24">
      ...
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">Project type: {c.outputType.replace('_', ' ')} • Received on {new Date(c.createdAt).toLocaleDateString()}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <div className="relative pl-8 space-y-10 border-l-2 border-zinc-100 dark:border-zinc-800 ml-4">
              ...
              />
              <TimelineStep 
                status="ASSIGNED_TO_PROVINCE" 
                currentStatus={c.status} 
                label="Provincial Allocation" 
        ...
        {/* History Feed */}
        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm mt-8">
          <h3 className="text-lg font-bold mb-6">Case History & Log</h3>
          <div className="space-y-6">
            ...
            {(!c.history || c.history.length === 0) && (
              <p className="text-sm text-zinc-400 italic">No history logged yet.</p>
            )}
          </div>
        </div>
      </div>

        {/* Sidebar: Details & Assignments */}
        <div className="space-y-8">
          ...
          <div className="bg-blue-600 rounded-3xl p-8 text-white shadow-xl shadow-blue-500/20">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-blue-100 italic">Deadline: {new Date(c.createdAt.getTime() + 7 * 24 * 60 * 60 * 1000).toLocaleDateString()}</p>
            </div>
          </div>
        </div>
      </div>
